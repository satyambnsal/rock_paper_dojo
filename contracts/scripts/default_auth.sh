...
export ACTIONS_ADDRESS=$(cat $manifest_file | jq -r '.contracts[] | select(.name == "rock_paper::actions::actions" ).address')
...
COMPONENTS=("Position" "MovesQueue" "RpsType" "GameData" "PlayerID" "Energy" "PlayerAddress" "PlayerAttPosition" )
