...
mod tests {
    ...
    use rock_paper::models::{
        position, player_att_position, rps_type, energy, player_id, player_address, Position,
        PlayerAttPosition, RpsType, Energy, Direction, Vec2, PlayerID, PlayerAddress, GAME_DATA_KEY,
        GameData
    };
    ...
    fn spawn_world() -> (ContractAddress, IWorldDispatcher, IActionsDispatcher) {
        ...
        let mut models = array![
            player_att_position::TEST_CLASS_HASH,
